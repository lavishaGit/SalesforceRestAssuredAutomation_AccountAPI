...
public class Constants {
    ...
    public final static String ENVIRONMENT_DETAILS_PROPERTIES_FILE = TEST_RESOURCES + File.separator + "EnvironmentDetails" + File.separator + "Salesforce.properties";
    public final static String TESTDATA_PROPERTIES_FILE = TEST_RESOURCES + File.separator + "Test" + File.separator + "Testdata.properties";
    ...
    public final static String EXCEL_FILEPATH = TEST_RESOURCES+ File.separator +"Filevalidate.xlsx";
}
